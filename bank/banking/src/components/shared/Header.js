                        ...
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item"><a href="#" className="nav-link">Pages <i
                                ...
                                <ul className="dropdown-menu">
                                    ...
                                    <li className="nav-item"><NavLink className='nav-link' to='/auth/open-account'>Open Account</NavLink>
                                    </li>
                            ...
                            <li className="nav-item"><a href='http://localhost:3000/' className="nav-link">Exit <i
                                ...
                                <ul className="dropdown-menu">
                                    ...
                                    <li className="nav-item"><NavLink to="/auth/logout" className="nav-link">Logout </NavLink></li>
                                </ul>
                            </li>
